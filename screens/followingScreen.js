...
const FollowingScreen = ({navigation}) => {
  ...
  return (
    <View style={styles.container}>
      ...
      <ScrollView>
            <List.Subheader style={styles.notiTitle}>Currently Following</List.Subheader>
        <TouchableOpacity>
        ...
        <Divider style={{borderColor: '#ffffff', borderWidth: 1,}} />
        <TouchableOpacity>
            <List.Item  title="Marco.kl" titleStyle={styles.notiStyle} left={() => <Avatar.Image style={styles.avatar}
                source={{
                uri: 'https://media.istockphoto.com/photos/close-up-portrait-of-brunette-woman-picture-id1154642632?k=6&m=1154642632&s=612x612&w=0&h=YTiNxRGupHJpMqQRu7Xh-U976mur5fp-cM_WEczpx04='}}
                size={50} />} 
                right={() => <Icon 
        ...
        <Divider style={{borderColor: '#ffffff', borderWidth: 1,}} />
        <TouchableOpacity>
            <List.Item  title="Moreno67" titleStyle={styles.notiStyle} left={() => <Avatar.Image style={styles.avatar}
                source={{
                uri: 'https://media.istockphoto.com/photos/close-up-portrait-of-brunette-woman-picture-id1154642632?k=6&m=1154642632&s=612x612&w=0&h=YTiNxRGupHJpMqQRu7Xh-U976mur5fp-cM_WEczpx04='}}
                size={50} />} 
                right={() => <Icon 
